...
<html lang="fr">
	...
	<h3>Conditions générales d'utilisation du site Polaire Studio</h3>
	<p class="h4">ARTICLE 1 : Objet</p>
	<p>
		Les présentes « conditions générales d'utilisation »
		ont pour objet l'encadrement juridique des modalités de mise à
		disposition des services du site Polaire Studio
...
<li>
	<p>
		Polaire Studio se réserve le droit de modifier unilatéralement et
		à tout moment le contenu des présentes conditions générales
		d'utilisation.
	</p>
</li></ul>

<p class="h4">ARTICLE 4 : accès aux services</p>
...
<li>
	...
	<p>
		...
		pas la responsabilité de Polaire Studio.
	</p>
	<p>
	...
	<p>
		L'Utilisateur a la possibilité de contacter le site par le formulaire de contact et/ou le numéro de téléphone.
	</p>
	...
	<p>
		...
		à la CNIL sous le numéro [numéro].
	</p>
	<p>
	...
	<li><p>unformulaire de contact ;</p>
	</li>
	<li><p>par mail à [adresse mail] ;</p>
	</li>
	<li><p>par voie postale au [adresse].</p>
	</li></ul>
	...
	<p>
		...
		responsabilité de Polaire Studio qui n'a
		pas le contrôle de ces liens.
	</p>
	<p>
	...
	<p>
		...
		seuls les tribunaux [du ressort de la Cour
		d'appel de / de la ville de] [Ville]
		sont compétents.
	</p>
	<p>Éventuellement</p>
	<p class="h4">ARTICLE 12 : Publication par l'Utilisateur</p>
	<p>
		Le site permet aux membres de publier des
		commentaires / des œuvres personnelles.
	</p>
	<p>
		Dans ses publications, le membre s'engage à respecter les règles
		de la Netiquette et les règles de droit en vigueur.
	</p>
	<p>
		Le site exerce une modération [a priori / a
		posteriori] sur les publications et se réserve le droit de
	...
	<a href="https://www.cnil.fr/fr/rgpd-par-ou-commencer" > réglement  général sur la protection des données (RGPD)</a>
